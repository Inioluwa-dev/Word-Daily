export const words = [
  ...
  },
  {
    ...
    example: 'His tenacious spirit helped him overcome obstacles.'
  },
  {
    word: 'Serendipity',
    pos: 'noun',
    definition: 'The occurrence of events by chance in a happy or beneficial way.',
    example: 'Finding the perfect book was pure serendipity.'
  },
  {
    word: 'Assiduous',
    pos: 'adjective',
    definition: 'Showing great care and perseverance.',
    example: 'Her assiduous research led to a breakthrough.'
  },
  {
    word: 'Conundrum',
    pos: 'noun',
    definition: 'A confusing and difficult problem or question.',
    example: 'Balancing work and family can be a real conundrum.'
  },
  {
    word: 'Gregarious',
    pos: 'adjective',
    definition: 'Fond of company; sociable.',
    example: 'He is gregarious and loves hosting parties.'
  },
  {
    word: 'Ineffable',
    pos: 'adjective',
    definition: 'Too great or extreme to be expressed in words.',
    example: 'The beauty of the view was ineffable.'
  },
  {
    word: 'Resilient',
    pos: 'adjective',
    definition: 'Able to withstand or recover quickly from difficult conditions.',
    example: 'Communities can be remarkably resilient after disasters.'
  },
  {
    word: 'Lucid',
    pos: 'adjective',
  ...
  },
  {
    ...
    example: 'He kept meticulous notes during the experiment.'
  },
  {
    word: 'Obfuscate',
    pos: 'verb',
    definition: 'To render obscure, unclear, or unintelligible.',
    example: 'Jargon can obfuscate the meaning of a simple idea.'
  },
  {
    word: 'Quintessential',
    pos: 'adjective',
